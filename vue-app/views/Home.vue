...
<template>
    <Layout>
        ...
        <p class="mb-4 px-8 text-xl font-extralight">
            Hello ! Bienvenue au PMU de soutien de la Saint-Fridolin. Une soirée
            de soutien à Estelle Zamme avec plein de jeux de pari rigolos.
        </p>
        <p class="mb-2 px-8">
        ...
        <p class="mb-2 px-8">
            ...
            Les jetons sont une monnaie d'échange pour participer aux jeux. Si
            tu gagnes à un jeu, tu reçoit des
            <span class="inline-flex items-baseline gap-1 font-extrabold">
                <Gift size="1em" class="self-center" />
                points,
            </span>
            que tu pourras échanger contre des super lots au kiosque à plaisir.
        </p>
        <p class="mb-2 px-8">
        ...
        <div class="flex flex-col gap-4 px-8">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Toutes les heures de 19h à 23h, 10 billes s'élancent sur
                        le parcours. Pariez sur l'une des trois premières pour
                        gagner des points.
                    </CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Vous choisissez la musique qui passe pendant toute la
                        soirée. Vous pouvez dépenser des jetons pour ajouter des
                        morceaux en file d'attente, et pour voter pour un des
                        deux morceux sur le ring.
                    </CardDescription>
                </CardHeader>
                <CardFooter>
                    <RouterLink class="w-full" :to="{ name: 'vote' }">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Vous avez vu notre beau dauphin à facette ? Pronostiquez
                        son poids. La personne la plus proche décroche le gros
                        lot.
                    </CardDescription>
                </CardHeader>
                <CardFooter>
